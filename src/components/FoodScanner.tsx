...
import { Camera, Upload, ArrowLeft, Zap, AlertTriangle, CheckCircle } from "lucide-react";
      ...
      setProgress(prev => {
        if (prev >= 100) {
          ...
          toast({
            ...
            description: "Makanan berhasil diidentifikasi dengan tingkat kepercayaan 92%",
          });
          return 100;
        }
        return prev + 10;
    ...
    <div className="min-h-screen bg-gradient-to-br from-smartfood-50 to-white py-8">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="flex items-center mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-smartfood-800">Scanner Makanan AI</h1>
            <p className="text-muted-foreground">Upload foto makanan untuk mendapatkan informasi nutrisi instan</p>
          </div>
        </div>
              ...
              >
                {selectedImage ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <p className="text-lg font-semibold text-smartfood-700">Pilih gambar makanan</p>
              ...
              {isAnalyzing && (
                <div className="space-y-4">
                  <div className="text-center">
                    <p className="font-semibold text-smartfood-700 mb-2">Menganalisis makanan...</p>
          ...
          <div className="space-y-6">
            {analysisResult && (
              <>
                <Card className="bg-white/80 backdrop-blur-sm border-smartfood-200">
                  <CardHeader>
                    <CardTitle className="flex items-center justify-between">
                      <span className="text-smartfood-800">Hasil Identifikasi</span>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div>
                        <h3 className="text-2xl font-bold text-smartfood-700">{analysisResult.foodName}</h3>
                        <p className="text-muted-foreground">{analysisResult.portion}</p>
                      </div>
                      ...
                      {analysisResult.allergens.length > 0 && (
                        <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                          <div className="flex items-center space-x-2 mb-2">
                            ...
                            <span className="font-semibold text-orange-800">Potensi Alergen</span>
                          </div>
                          <div className="flex flex-wrap gap-2">
                            {analysisResult.allergens.map((allergen: string, index: number) => (
                ...
                <Card className="bg-white/80 backdrop-blur-sm border-smartfood-200">
                  <CardHeader>
                    <CardTitle className="text-smartfood-800">Informasi Nutrisi</CardTitle>
                  </CardHeader>
                  <CardContent>
                    ...
                    <div className="flex justify-between items-center text-sm">
                      ...
                      <span className="font-semibold">{analysisResult.nutrition.fiber}g</span>
                    </div>
                  </CardContent>
                </Card>
              ...
              <Card className="bg-gradient-to-br from-smartfood-100 to-smartfood-200 border-smartfood-300">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-smartfood-700">
                    Upload gambar makanan untuk melihat informasi nutrisi lengkap dengan teknologi AI terdepan.
                  </p>
                </CardContent>
              </Card>
            )}
